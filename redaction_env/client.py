...
"""Redaction Env Environment Client."""
...
class RedactionEnv(
    EnvClient[RedactionAction, RedactionObservation, State]
):
    """
    Client for the Redaction Env Environment.
    ...
    Example:
        ...
        ...
        ...     result = client.step(RedactionAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = RedactionEnv.from_docker_image("redaction_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(RedactionAction(message="Test"))
        ... finally:
        ...     client.close()
    """
